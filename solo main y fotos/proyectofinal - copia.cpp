...
//*****casa*****
	...
	//piso
		glTranslatef(0,-10,0);
	//	pisoCasa.prisma(1,80,85, t_fachada4.GLindex);
		pisoCasa.prisma(.1, 85, 85, t_ladrillosama.GLindex);
		...
		pisoCasa.prisma(1,350,300, textGrass.GLindex);
	glPopMatrix();

	//paredes de la puerta
	glPushMatrix();
		glTranslatef(-27.5,10,-42);
		pisoCasa.prisma(40,30,1, t_paredgris2.GLindex);
		glPushMatrix();
		glPopMatrix();
		...
		glScalef(8, 37, 1);
		pisoCasa.prisma(1,1,1, textPuerta_princ.GLindex);
		glPopMatrix();

	//marco de la puerta
	//der
	glPushMatrix();
	glTranslatef(-40, 8.0, -42);
	glScalef(1.0, 38, 1.0);
	pisoCasa.prisma(1.0, 1.0, 1.0, t_fachada1.GLindex);
	glPopMatrix();

	
	//izq
	glPushMatrix();
	glTranslatef(-31, 8.0, -42);
	glScalef(1.0, 38, 1.0);
	pisoCasa.prisma(1.0, 1.0, 1.0, t_fachada1.GLindex);
	glPopMatrix();
	...
	glPushMatrix();
		...
		glScalef(2,55, 1);
		cubo.prisma(1,1,1, textAlmohada.GLindex);
	glPopMatrix();
	...
	glScalef(6, 30, 1);
	cubo.prisma(1, 1, 1, t_paredgris2.GLindex);
	glPopMatrix();
...
{			
			...
			glScalef(4.0, 3.0, 1.0);  //Tamaño de cabecera
			cama.prisma(1.0, 1.0, 1.0, textMaderaCama.GLindex);
			glPopMatrix();
			...
			glRotatef(120, 1.0f, 1.0f, 1.0f);
			cama.cilindro(3.5, 0.5, 20, textMaderaCama.GLindex);
			glPopMatrix();
...
//////////////////////////INICIO DE LA MESDA GRANDE		
				...
				glScalef(12, 7.0, 12);
				cama.prisma(1., 1.0, 1.0, textMaderaCama.GLindex);
				glPopMatrix();
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////PLATO PARA PAPAS

			//	glPushMatrix();
			//	glTranslatef(22.0, 10.0, -10.6);
			 // 	glScalef(5.0, 3.0, 180);
			//	cama.esfera(180.0,0.0,0.0, textAlmohada.GLindex);
			//	glPopMatrix();
...
void dibujaBuro(GLfloat xMadera, GLfloat yMadera, GLfloat zMadera, GLfloat xPosBuro, GLfloat yPosBuro, GLfloat zPosBuro)
{
		glPushMatrix();		
			...
			glScalef(6.25, 0.5, 1.0);  //Tamaño de cabecera
			cama.prisma(1.0, 1.0, 1.0, textMaderaBuro.GLindex);
			glPopMatrix();
			...
			buro.cilindro(0.7, 1.0, 20, textMaderaBuro.GLindex);
			glPopMatrix();
			...
			glScalef(0.5, 0.4, 1.0);  //Tamaño de cabecera
			cama.prisma(1.0, 1.0, 1.0, textMaderaBuro.GLindex);
			glPopMatrix();
			...
			glScalef(0.6, 0.4, 1.0);  //Tamaño de cabecera
			cama.prisma(1.0, 1.0, 1.0, textMaderaBuro.GLindex);
			glPopMatrix();
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	t_ventana2.LoadTGA("ventana2.tga");
	t_ventana2.BuildGLTexture();
	t_ventana2.ReleaseImage();

	t_ventana3.LoadTGA("ventana3.tga");
	t_ventana3.BuildGLTexture();
	t_ventana3.ReleaseImage();
	...
	t_ladrillosama.LoadTGA("ladrillosama.tga");
	t_ladrillosama.BuildGLTexture();
	t_ladrillosama.ReleaseImage();
